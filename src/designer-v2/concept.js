...
**scene**: 모델이 어떤 공간에서 어떤 행동을 하는지 한 문장.
  - 타겟 페르소나의 라이프스타일에서 감성적 순간을 포착.
  - **절대 금지**: 직업 → 직장 공간 직역. "직장인" → "사무실·회사·책상" 사용 금지.
  - 대신 데일리 라이프의 감성적 공간 사용: 집 욕실, 창가, 드레스룸, 카페 등.
  - 예: "30대 여성이 자연광이 드는 집 창가 거울 앞에서 데일리 메이크업을 마무리하는 조용한 아침"

**visual_mood**: 광고의 전체 분위기·빛·피부 질감 한 문장.
  - 브랜드 톤앤매너에서 도출. 트렌드 분위기는 참고만.
  - 예: "정제된 럭셔리, 소프트 자연광, 세미매트 피부 질감"

**product_moment**: 제품이 화면에 자연스럽게 등장하는 감성적 순간.
  - 사용법 튜토리얼 묘사 금지. "손등에 몇 방울" 같은 기능적 설명 X.
  - 제품이 배경에 놓이거나, 손에 쥐어지거나, 피부 위에 자연스럽게 스치는 장면.
  - 예: "미니멀한 화장대 위에 놓인 파운데이션 — 빛을 받아 고급스러운 질감이 드러남"

**color_tone**: 브랜드 아이덴티티 기반 주조색 + 보조색 2~3개.
  - 트렌드 키워드(피부색·제형색)가 아니라 브랜드 tone_and_manner에서 도출.
  - 럭셔리·프리미엄 → 딥 블랙, 골드, 아이보리 크림, 샴페인 등
  - 예: "딥 블랙, 샴페인 골드, 소프트 아이보리"
